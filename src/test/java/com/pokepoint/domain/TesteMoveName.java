...
public class TesteMoveName {
	...
	private static final String SPANISH_NAME = "Garra de Dragón";
	
	@Test
	public void criarObjeto() {
		MoveName moveName = new MoveName(ID, ENGLISH_NAME, JAPANESE_NAME, PORTUGUESE_NAME, SPANISH_NAME);
		...
		assertEquals(moveName.getSpanishName(), SPANISH_NAME);
